...
<body>
        ...
        <div class="wrapper">
            ...
            <div class="container-fluid mainContents">
                <div class="card card-body main_card mt-2 shadow-lg p-3 mb-2">
                    <div class="text-end">
                        <a href="{{ url('/OrganizationTable') }}">
                            <button class="btn AddBtn px-4">View</button>
                        </a>
                    </div>

                    <form class="Organization_add AddForm" id="organization" novalidate>
                        {{ csrf_field() }}
                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-12">
                                ...
                                <input type="text" class="form-control mt-1 inputfield" id="organization_name"
                                    name="OrganizationName" placeholder="" autofocus required>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-12">
    ...
    <script type="text/javascript">
        ...
        document.getElementById('organization_name').addEventListener('input', function(event) {
