...
<body>
    ...
    <main id="main" class="main">
            ...
            <div class="modal-dialog modal-dialog-centered modal-md">
                <div class="modal-content cntrymodalbg">
                    <div class="modal-header modelhead py-2">
                        <h6 class="modal-title" id="exampleModalLabel">Enquiry Type</h6>
                            ...
                            <div class="row">
                                <div class=" col-12">
                                    ...
                                    <input type="text" class="form-control mt-1 inputfield" id="enquiry_name"
                                        name="EnquiryName" pattern="[^0-9]+" placeholder="Enter Enquiry Type" autofocus
                                        required>
                                </div>
                                <div class=" col-12">
        ...
        <div class="modal fade addUpdateModal" id="enquiryViewModal" tabindex="-1" data-bs-backdrop="static"
            data-bs-keyboard="false" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-md">
                <div class="modal-content cntrymodalbg">
                    <div class="modal-header modelhead py-2">
                    ...
                    <div class="modal-body">
                        <form class="ViewEnquiry " id="view_enquiry" style="display: none;" novalidate>
                            {{ csrf_field() }}
                            <div class="row">
                                <div class=" col-12">
                                    <input type="hidden" id="view_enquiry_id">
                                    <label class="mt-2 mb-1 inputlabel">Name</label><br>
                                    <input disabled class="form-control mt-1 inputfield" id="view_enquiry_name"
        ...
        <div class="modal fade delModal" id="delModal" tabindex="-1" data-bs-backdrop="static"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h4 class="text-center">Do you want to delete this EnquiryType?</h4>
        ...
        <div class="container-fluid px-4 ">
            <h4 class="mt-1 d-flex justify-content-center py-1 contitle">Enquiry Type </h4>
        </div>
    ...
    <script type="text/javascript">
        document.getElementById('enquiry_name').addEventListener('input', function(event) {
        ...
        document.getElementById('update_enquiry_name').addEventListener('input', function(event) {
            var input = event.target;
            var value = input.value;
        ...
        var MasterTable = $('.MasterTable').DataTable({
            ...
            ajax: "{{ route('enquirytype.Enquirytype') }}",
            columns: [{
                    data: 'DT_RowIndex',
                    name: 'DT_RowIndex'
                },
        ...
        $('#MasterTable').on('click', '.btn_edit', function() {
            ...
            var settings = {
                "url": "/api/enquiry-type/" + EditEnquiryType + "",
                "method": "GET",
                "timeout": 0,
            };
            ...
            $.ajax(settings).done(function(response) {
                ...
                if (EnquiryTypeedit.success == true) {
                    ...
                    $('#enquiry_type').hide();
                    $('#update_enquiry').show();
                    var CoTypeDataArray = EnquiryTypeedit.enquirytype;
                    for (const key in CoTypeDataArray) {
                        var EnquiryName = CoTypeDataArray['name'];
                        var EnquiryRemark = CoTypeDataArray['remarks'];
                        var EnquiryTypeId = CoTypeDataArray['id'];

                    }
                    $("#update_enquiry_id").val(EnquiryTypeId);
                    $("#update_enquiry_name").val(EnquiryName);
                    $("#update_remarks").val(EnquiryRemark);
                }
            });
        ...
        $("#update_enquiry").validate({
            ...
            submitHandler: function(form) {
                ...
                var UpdateEnTypeName = $('#update_enquiry_name').val();
                var UpdateEnTypeRemark = $('#update_remarks').val();
                var UpdatedDy = $('#updated_by').val();


                $.ajax({

                    url: "/api/enquirytype/" + UpdateId + "",
                    method: "PUT",
                    timeout: 0,
                    headers: {
                        "Accept": "application/json",
                    ...
                    data: {
                        name: UpdateEnTypeName,
                        remarks: UpdateEnTypeRemark,
        ...
        $('#MasterTable').on('click', '.btn_delete', function() {
            ...
            swal({
                ...
                if (willDelete) {
                    $.ajax({
                        url: "/api/enquirytype/" + DeleteEnType,
                        method: "DELETE",
                        timeout: 0,
                        headers: {
                            "Accept": "application/json",
