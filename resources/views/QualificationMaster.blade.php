...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="modal fade addUpdateModal" id="qualification_modal" tabindex="-1" data-bs-backdrop="static"
            data-bs-keyboard="false" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-md">
                <div class="modal-content cntrymodalbg">
                    <div class="modal-header modelhead py-2">
                        <h6 class="modal-title" id="exampleModalLabel">Qualification</h6>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form class="Qualification AddForm" id="qualification" novalidate>
                            {{ csrf_field() }}
                            <div class="row">
                                <div class=" col-12">
                                    <label class="mt-2 mb-1 inputlabel">Name<span style="color:red; font-size:15px">
                                            *</span></label><br>
                                    <input type="text" class="form-control mt-1 inputfield" id="qualification_name"
                                        name="QualificationName" placeholder="Enter Qualification Name" autofocus
                                        required>
                                </div>
                                <div class=" col-12">
                        ...
                        <form class="UpdateQualification UpdateForm" id="update_qualification" style="display: none;"
                            novalidate>
                            {{ csrf_field() }}
                            <div class="row">
                                <div class=" col-12">
                                    ...
                                    <input type="text" class="form-control mt-1 inputfield"
                                        id="update_qualification_name" name="UpdateQualificationName" autofocus
                                        required>
                                </div>
                                <div class=" col-12">
                                    <label class="mt-3 mb-1 inputlabel">Remarks </label><br>
        ...
        <div class="modal fade addUpdateModal " id="QualificationViewModal" tabindex="-1" data-bs-backdrop="static"
            data-bs-keyboard="false" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-md">
                <div class="modal-content cntrymodalbg">
                    <div class="modal-header modelhead py-2">
                    ...
                    <div class="modal-body">
                        <form class="ViewQualification " id="view_qualification" style="display: none;" novalidate>
                            {{ csrf_field() }}
                            <div class="row">
                                <div class=" col-12">
                                    <input type="hidden" id="view_qualification_id">
                                    <label class="mt-2 mb-1 inputlabel">Name</label><br>
                                    <input disabled class="form-control mt-1 inputfield" id="view_qualification_name"
                                        name="ViewQualificationName" autofocus required>
                                </div>
                                <div class=" col-12">
                                    <label class="mt-3 mb-1 inputlabel">Remarks </label><br>
        ...
        <div class="modal fade delModal" id="delModal" tabindex="-1" data-bs-backdrop="static"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h4 class="text-center">Do you want to delete this Qualification?</h4>
        ...
        <div class="container-fluid px-4 ">
            <h4 class="mt-1 d-flex justify-content-center py-1 contitle">Qualification </h4>
        </div>
        <div class="wrapper">
            <!--CONTENTS-->
                    ...
                    <div class="main_heading d-flex justify-content-between mb-2 shadow p-2 subheading">
                        ...
                        <div class="">
                            <button class="btn AddBtn px-4" data-bs-toggle="modal"
                                data-bs-target="#qualification_modal">+ Add</button>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            $('#qualification_modal').on('shown.bs.modal', function() {
                $('#qualification_name').focus();
            });
        });

        document.getElementById('qualification_name').addEventListener('input', function(event) {
        ...
        var MasterTable = $('.MasterTable').DataTable({
            ...
            ajax: "{{ route('qualification.Qualification') }}",
            columns: [{
                    data: 'DT_RowIndex',
                    name: 'DT_RowIndex'
                },
        ...
        $("#qualification").validate({
            ...
            submitHandler: function(form) {
                var qualificationName = $('#qualification_name').val();
                var qualificationRemark = $('#remarks').val();
                $.ajax({
        ...
        $('#MasterTable').on('click', '.btn_edit', function() {
            ...
            var settings = {
                "url": "/api/qualification/" + EditEnquiryType + "",
                "method": "GET",
                "timeout": 0,
            };
            ...
            $.ajax(settings).done(function(response) {
                ...
                if (EnquiryTypeedit.success == true) {
                    ...
                    $('#qualification').hide();
                    $('#update_qualification').show();
                    var CoTypeDataArray = EnquiryTypeedit.qualifications;
                    for (const key in CoTypeDataArray) {
                        var QualifiName = CoTypeDataArray['name'];
                        var QualifiRemark = CoTypeDataArray['remarks'];
                        var QualifiId = CoTypeDataArray['id'];

                    }
                    $("#update_qualification_id").val(QualifiId);
                    $("#update_qualification_name").val(QualifiName);
                    $("#update_remarks").val(QualifiRemark);
                }
            });
        ...
        $("#update_qualification").validate({
            ...
            submitHandler: function(form) {
                ...
                var UpdateQuName = $('#update_qualification_name').val();
                var UpdateQuRemark = $('#update_remarks').val();
                var UpdatedDy = $('#updated_by').val();


                $.ajax({

                    url: "/api/qualification/" + UpdateId + "",
                    method: "PUT",
                    timeout: 0,
                    headers: {
                        "Accept": "application/json",
        ...
        $('#MasterTable').on('click', '.btn_delete', function() {
            ...
            swal({
                ...
                if (willDelete) {
                    $.ajax({
                        url: "/api/qualification/" + DeleteEnType,
                        method: "DELETE",
                        timeout: 0,
                        headers: {
                            "Accept": "application/json",
        ...
        $('#MasterTable').on('click', '.btn_view', function() {
            ...
            var settings = {
                "url": "/api/qualification/" + ViewEnType + "",
                "method": "GET",
                "timeout": 0,
            };
            ...
            $.ajax(settings).done(function(response) {
                ...
                if (Enedit.success == true) {
                    $('#QualificationViewModal').modal('show');
                    $('#view_qualification').show();
                    var EnDataArray = Enedit.qualifications;
                    for (const key in EnDataArray) {
                        var QualificationName = EnDataArray['name'];
                        var QualificationRemark = EnDataArray['remarks'];
                        var QualificationId = EnDataArray['id'];
                    }
                    $("#view_qualification_id").val(QualificationId);
                    $("#view_qualification_name").val(QualificationName);
                    $("#view_remarks").val(QualificationRemark);
                }
            });
