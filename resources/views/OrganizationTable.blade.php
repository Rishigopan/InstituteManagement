...
<body>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h4 class="text-center">Do you want to delete this Organization?</h4>
            ...
            <div class="container-fluid mainContents">
                <div class="card card-body main_card mt-2 shadow-lg p-3 mb-2">
                    <div class="main_heading d-flex justify-content-between mb-2 shadow p-2 subheading">
                        ...
                        <div class="">
                            <a href="{{ url('/organization') }}"class="btn AddBtn px-4">+ Add</a>
    ...
    <script type="text/javascript">
        ...
        var MasterTable = $('.MasterTable').DataTable({
            ...
            ajax: "{{ route('organizationTable.OrgTable') }}",
            columns: [{
                    data: 'DT_RowIndex',
                    name: 'DT_RowIndex'
                },
        ...
        $('#MasterTable').on('click', '.btn_delete', function() {
            ...
            swal({
                ...
                if (willDelete) {
                    $.ajax({
                        url: "/api/organization/" + DeleteEnType,
                        method: "DELETE",
                        timeout: 0,
                        headers: {
