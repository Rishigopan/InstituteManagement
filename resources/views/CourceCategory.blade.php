...
<html lang="en">
  ...
  <body>
        ...
        <main id="main" class="main">
            ...
            <div class="modal fade addUpdateModal" id="CourseCatModal" tabindex="-1" data-bs-backdrop="static"               data-bs-keyboard="false" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-md">
                    <div class="modal-content cntrymodalbg">
                        <div class="modal-header modelhead py-2">
                            <h6 class="modal-title" id="exampleModalLabel">Course Category</h6>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <form class="Course AddForm" id="course_category" novalidate>
                                {{ csrf_field() }}
                                <div class="row">
                                    <div class=" col-12">
                                        <label class="mt-2 mb-1 inputlabel">Name<span  style="color:red; font-size:15px" > *</span></label><br>
                                        <input type="text" class="form-control mt-1 inputfield" id="course_name" name="CourseName" placeholder="Enter Course Category" autofocus required>
                                    </div>                           
                                    <div class=" col-12">
                            ...
                            <form class="UpdateCourseCat UpdateForm" id="update_cource_cat" style="display: none;" novalidate>
                            {{ csrf_field() }}
                                <div class="row">
                                    <div class=" col-12">
                                        <input type="hidden"  id="update_course_cat_id" >
                                        <label class="mt-2 mb-1 inputlabel">Name<span  style="color:red; font-size:15px" > *</span></label><br>
                                        <input type="text" class="form-control mt-1 inputfield" id="update_course_name" name="UpdateCourseName"  autofocus required>
                                    </div>                           
                                    <div class=" col-12">
                                        <label class="mt-3 mb-1 inputlabel">Remarks </label><br>
            ...
            <div class="modal fade " id="CourceCatViewModal" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-md">
                    <div class="modal-content cntrymodalbg">
                        <div class="modal-header modelhead py-2">
                            <h6 class="modal-title" id="exampleModalLabel">Course Category</h6>
                        ...
                        <div class="modal-body">
                            <form class="ViewCourseCat " id="view_course_cat" style="display: none;" novalidate>
                            {{ csrf_field() }}
                                <div class="row">
                                    <div class=" col-12">
                                        <input type="hidden"  id="view_course_cat_id" >
                                        <label class="mt-2 mb-1 inputlabel">Name</label><br>
                                        <input  disabled class="form-control mt-1 inputfield" id="view_course_name" name="ViewCourseName"  autofocus required>
                                    </div>                           
                                    <div class=" col-12">
                                        <label class="mt-3 mb-1 inputlabel">Remarks </label><br>
            ...
            <div class="modal fade delModal" id="delModal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <h4 class="text-center">Do you want to delete this Course Category?</h4>
             ...
             <div class="modal fade ResponseModal" id="ResponseModal" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="container-fluid px-4 ">
                    <h4 class="mt-1 d-flex justify-content-center py-1 contitle">Course Category </h4>        
                </div>
                    ...
                    <div class="container-fluid mainContents">
                        <div class="card card-body main_card mt-2 shadow-lg p-3 mb-2">                           
                            <div class="main_heading d-flex justify-content-between mb-2 shadow p-2 subheading">
                                ...
                                <div class="">
                                    <button class="btn AddBtn px-4" data-bs-toggle="modal" data-bs-target="#CourseCatModal">+  Add</button> 
         ...
         $('.MasterTable thead tr')
            ...
            var MasterTable = $('.MasterTable').DataTable({
                ...
                ajax: "{{ route('courcecat.Coursecatagory') }}",
                columns: [
     ...
     $("#course_category").validate({
            ...
            submitHandler: function(form) {
                var CourseCatName = $('#course_name').val();
                var CourseCatRemark = $('#remarks').val();
                $.ajax({
                    ...
                    data: {
                        name: CourseCatName,
                        remarks: CourseCatRemark,
                    },
                    beforeSend: function() {
                        $('.loader').show();
                        $('#CourseCatModal').modal('hide');
                        $('.mainContents').hide();
        ...
        $('#MasterTable').on('click', '.btn_edit', function() {
            var EditCourseCat = $(this).val();
            console.log(EditCourseCat);

            var settings = {
                "url": "/api/course-category/" + EditCourseCat + "",
                "method": "GET",
                "timeout": 0,
            };
            ...
            $.ajax(settings).done(function(response) {
                ...
                if (EnquiryTypeedit.success == true) {
                    $('#CourseCatModal').modal('show');
                    $('#course_category').hide();
                    $('#update_cource_cat').show();
                    var CoTypeDataArray = EnquiryTypeedit.coursecategory;
                    for (const key in CoTypeDataArray) {
                        var CourseCatName = CoTypeDataArray['name'];
                        var CourseCatRemark = CoTypeDataArray['remarks'];
                        var CourseCatId = CoTypeDataArray['id'];

                    }
                    $("#update_course_cat_id").val(CourseCatId);
                    $("#update_course_name").val(CourseCatName);
                    $("#update_remarks").val(CourseCatRemark);
                }
            });
        ...
        $("#update_cource_cat").validate({
            ...
            submitHandler: function(form) {
                var UpdateId = $('#update_course_cat_id').val();
                var UpdateCourseCatName = $('#update_course_name').val();
                var UpdateCourseCatRemark = $('#update_remarks').val();
                var UpdatedDy = $('#updated_by').val();


                $.ajax({

                    url: "/api/course-category/" + UpdateId + "",
                    method: "PUT",
                    timeout: 0,
                    headers: {
                        "Accept": "application/json",
                    ...
                    data: {
                        name: UpdateCourseCatName,
                        remarks: UpdateCourseCatRemark,
        ...
        $('#MasterTable').on('click', '.btn_delete', function() {
            ...
            swal({
                ...
                if (willDelete) {
                    $.ajax({
                        url: "/api/course-category/" + DeleteEnType,
                        method: "DELETE",
                        timeout: 0,
                        headers: {
                            "Accept": "application/json",
             ...
             $('#MasterTable').on('click', '.btn_view', function () {
                ...
                var settings = {
                "url": "/api/course-category/"+ViewEnType+"",
                "method": "GET",
                "timeout": 0,
                };
                ...
                var EnResult = JSON.stringify(response);
                    ...
                    if (Enedit.success == true) {
                        $('#CourceCatViewModal').modal('show');                       
                        $('#view_course_cat').show();
                        var EnDataArray = Enedit.coursecategory;
                        for(const key in EnDataArray){
                            var CourseCatName = EnDataArray['name'];
                            var CourseCatRemark = EnDataArray['remarks'];
                            var CourseCatId = EnDataArray['id'];

                        }
                        $("#view_course_id").val(CourseCatId);
                        $("#view_course_name").val(CourseCatName);
                        $("#view_remarks").val(CourseCatRemark);
                    }
                });
           ...
           //validation
            document.getElementById('course_name').addEventListener('input', function(event) {
...
//validation
document.getElementById('update_course_name').addEventListener('input', function(event) {
            var input = event.target;
            var value = input.value;
            var newValue = value.replace(/[^a-zA-Z\s]/g, ''); // Remove any digits and special characters from the input value
            if (newValue !== value) {
...
$(document).ready(function() {
                $('#CourseCatModal').on('shown.bs.modal', function() {
                    $('#course_name').focus();
                });
            });
    </script>
