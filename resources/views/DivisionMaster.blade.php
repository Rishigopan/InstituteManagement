...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="modal fade addUpdateModal" id="division_modal" tabindex="-1" data-bs-backdrop="static"
            data-bs-keyboard="false" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-md">
                <div class="modal-content cntrymodalbg">
                    <div class="modal-header modelhead py-2">
                        <h6 class="modal-title" id="exampleModalLabel">Division</h6>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form class="Division AddForm" id="division" novalidate>
                            {{ csrf_field() }}
                            <div class="row">
                                <div class=" col-12">
                                    <label class="mt-2 mb-1 inputlabel">Name<span style="color:red; font-size:15px">
                                            *</span></label><br>
                                    <input type="text" class="form-control mt-1 inputfield" id="division_name"
                                        name="DivisionName" placeholder="Enter Division Name" autofocus required>
                                </div>
                                <div class=" col-12">
                        ...
                        <form class="UpdateDivision UpdateForm" id="update_division" style="display: none;" novalidate>
                            {{ csrf_field() }}
                            <div class="row">
                                <div class=" col-12">
                                    <input type="hidden" id="update_division_id">
                                    <label class="mt-2 mb-1 inputlabel">Name<span style="color:red; font-size:15px">
                                            *</span></label><br>
                                    <input type="text" class="form-control mt-1 inputfield" id="update_division_name"
                                        name="UpdateDivisionName" autofocus required>
                                </div>
                                <div class=" col-12">
                                    <label class="mt-3 mb-1 inputlabel">Remarks </label><br>
        ...
        <div class="modal fade " id="DivisionViewModal" tabindex="-1" data-bs-backdrop="static"
            data-bs-keyboard="false" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-md">
                <div class="modal-content cntrymodalbg">
                    <div class="modal-header modelhead py-2">
                    ...
                    <div class="modal-body">
                        <form class="ViewDivision " id="view_division" style="display: none;" novalidate>
                            {{ csrf_field() }}
                            <div class="row">
                                <div class=" col-12">
                                    <input type="hidden" id="view_division_id">
                                    <label class="mt-2 mb-1 inputlabel">Name</label><br>
                                    <input disabled class="form-control mt-1 inputfield" id="view_division_name"
                                        name="ViewDivisionName" autofocus required>
                                </div>
                                <div class=" col-12">
                                    <label class="mt-3 mb-1 inputlabel">Remarks </label><br>
        ...
        <div class="modal fade delModal" id="delModal" tabindex="-1" data-bs-backdrop="static"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h4 class="text-center">Do you want to delete this Division?</h4>
        ...
        <div class="container-fluid px-4 ">
            <h4 class="mt-1 d-flex justify-content-center py-1 contitle">Division </h4>
        </div>
            ...
            <div class="container-fluid mainContents">
                <div class="card card-body main_card mt-2 shadow-lg p-3 mb-2">
                    <div class="main_heading d-flex justify-content-between mb-2 shadow p-2 subheading">
                        ...
                        <div class="">
                            <button class="btn AddBtn px-4" data-bs-toggle="modal" data-bs-target="#division_modal">+
                                Add</button>
    ...
    <script type="text/javascript">
        ...
        $("#division").validate({
            ...
            submitHandler: function(form) {
                ...
                var DivisionRemark = $('#remarks').val();
                $.ajax({
                    url: "/api/division",
                    method: "POST",
                    timeout: 0,
        ...
        $('#MasterTable').on('click', '.btn_edit', function() {
            ...
            var settings = {
                "url": "/api/division/" + EditEnquiryType + "",
                "method": "GET",
                "timeout": 0,
            };
            ...
            $.ajax(settings).done(function(response) {
                ...
                if (EnquiryTypeedit.success == true) {
                    ...
                    $('#division').hide();
                    $('#update_division').show();
                    var CoTypeDataArray = EnquiryTypeedit.divisions;
                    for (const key in CoTypeDataArray) {
                        var DivisionName = CoTypeDataArray['name'];
                        var DivisionRemark = CoTypeDataArray['remarks'];
                        var DivisionId = CoTypeDataArray['id'];

                    }
                    $("#update_division_id").val(DivisionId);
                    $("#update_division_name").val(DivisionName);
                    $("#update_remarks").val(DivisionRemark);
                }
            });
        ...
        $("#update_division").validate({
            ...
            submitHandler: function(form) {
                var UpdateId = $('#update_division_id').val();
                var UpdateDivisionName = $('#update_division_name').val();
                var UpdateDivisionRemark = $('#update_remarks').val();
                var UpdatedDy = $('#updated_by').val();


                $.ajax({

                    url: "/api/division/" + UpdateId + "",
                    method: "PUT",
                    timeout: 0,
                    headers: {
                        "Accept": "application/json",
                    ...
                    data: {
                        name: UpdateDivisionName,
                        remarks: UpdateDivisionRemark,
        ...
        $('#MasterTable').on('click', '.btn_view', function() {
            ...
            $.ajax(settings).done(function(response) {
                ...
                if (Enedit.success == true) {
                    $('#DivisionViewModal').modal('show');
                    $('#view_division').show();
                    var EnDataArray = Enedit.divisions;
                    for (const key in EnDataArray) {
                        var DivisionName = EnDataArray['name'];
                        var DivisionRemark = EnDataArray['remarks'];
                        var DivisionId = EnDataArray['id'];

                    }
                    $("#view_division_id").val(DivisionId);
                    $("#view_division_name").val(DivisionName);
                    $("#view_remarks").val(DivisionRemark);
                }
            });
