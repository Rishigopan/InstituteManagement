    ...
    public function BranchTable(Request $request) {
        ...
        if ($request->ajax()) {
            ...
            ->addColumn('action', function($row){
                // $actionBtn = "<div class='text-center actions'>    <a  class='edit btn me-2' href='branchEdit/".$row["id"]."'> Update </a>   <button  class='edit btn me-2' value='".$row["id"]."'>  <i class='ri-eye-line'></i></button>      <button  class='btn btn_delete' value='".$row["id"]."'> <i class='ri-delete-bin-6-line'></i> </button> </div>";
