...
class CourseProController extends Controller
{
    public function CoursePro(Request $request) {

        if ($request->ajax()) {
            $data = CourseProvider::select( 'id','name','remarks')->get();
