...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('parent_infos', function (Blueprint $table) {
            ...
            $table->bigInteger('primary_mobile_no')->length(30)->nullable()->default(0);
            $table->bigInteger('secondary_mobile_no')->length(30)->nullable()->default(0);
            $table->string('primary_email', 120)->nullable();
            $table->string('secondary_email', 120)->nullable();
